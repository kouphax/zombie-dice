...
*/
cljs_uuid_utils.core.uuid_string = (function uuid_string(a_uuid){
...
*/
cljs_uuid_utils.core.make_random_squuid = (function make_random_squuid(){
...
*/
cljs_uuid_utils.core.make_random_uuid = (function make_random_uuid(){
var f = (function f(){
return cljs.core.rand_int((16)).toString((16));
});
var g = (function g(){
...
return cljs.core.re_pattern([cljs.core.str("^"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("$")].join(''));
})();
/**
...
*/
cljs_uuid_utils.core.valid_uuid_QMARK_ = (function valid_uuid_QMARK_(maybe_uuid){
...
*/
cljs_uuid_utils.core.make_uuid_from = (function make_uuid_from(maybe_uuid){
var temp__4126__auto__ = cljs_uuid_utils.core.valid_uuid_QMARK_(maybe_uuid);
